...
<template>
        ...
        <div class = "container w-100 mb-lg-6">
            <div class = "row align-items-stretch">
                    ...
                    <div class = "text-center mt-5 mb-4">
                        <h2 class = "fw-bold">¿Cuál es tu destino?</h2>
                    </div>
    ...
    <DestinoPasajeros v-if = "!siguienteForm" :ubicacionDestino = "ciudadSeleccionada" :datosViajes = "datosViajes" />
...
<script>
import DestinoPasajeros from './DestinoPasajeros'
import { ref } from 'vue'
