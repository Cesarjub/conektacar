...
export default 
{
    ...
    setup(props) 
    {
        ...
        {   
            ...
            props.datosViajes.latNuevaParada = ubicacionParada.value.lat
            props.datosViajes.lngNuevaParada = ubicacionParada.value.lng
            props.datosViajes.direccionNuevaParada = direccion.value
        }
