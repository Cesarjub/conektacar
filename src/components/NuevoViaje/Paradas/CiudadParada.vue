...
<template>
    ...
    <SeleccionarParada v-if = "!siguienteForm" :ubicacionParada = "ciudadSeleccionada" :datosViajes = "datosViajes" />

<!--Parada: {{ ciudadSeleccionada }}-->

</template>

<script>
import SeleccionarParada from './SeleccionarParada'
import { ref } from 'vue'
